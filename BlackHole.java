...
public class BlackHole extends SpaceObject implements Diameter {

    private String name;
    private String type;

    public BlackHole(int weight, int circumference, String name, String type, int distanceToEarth) {
